/* PrismJS 1.30.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+c+csharp+cpp+docker+erlang+git+go+haskell+java+javadoclike+latex+lisp+lua+markup-templating+matlab+mermaid+pascal+perl+php+powershell+python+r+ruby+rust+scala+sql+typescript+yaml+zig */
var _self =
